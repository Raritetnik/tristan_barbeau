export default {
    ...
    courtierImmobilier: 'Courtier immobilier résidentiel',
    proposMoi: 'À propos de moi',

    // About - Accueil
    accueilAproposMoi: 'J’aborde mon travail avec une compréhension solide du marché' +
    ...
    accueilSuiteProposMoi: 'La base de mon approche repose sur une attention particulière aux' +
    ...
    soir: 'Soir',
    midi: 'Après-midi',
    finSemaine: 'Fin semaine',
    recherche: 'Vous chercher à...',
    achat: 'Acheter',
    vendre: 'Vendre',
    ...
    pretHypoTitle: 'Prêt hypothécaire',
    amountPretHypo: 'Montant du prêt hypothécaire',
    tauxIntéret: 'Taux d\'intéret',
    periodeAmortissement: 'Période d\'amortissement',
